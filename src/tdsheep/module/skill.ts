...
export class BaseSkill extends BaseModule {
  ...
  public skillTag2: string = "";
  public skillTag3: string = "";
  public nextLevelSkillTag1: string = "";
  public nextLevelSkillTag2: string = "";
  public nextLevelSkillTag3: string = "";
  public m_updateFunction: () => void = () => {};

  constructor(_id: string, _level: number, _isTest = false) {
    super();
    if (_isTest) {
  ...
  get data() {
    return this.m_data as BaseSkillData;
  }
...
export class AoeAttackSkill extends TowerSkill {
  ...
  get nextEffectRate() {
    return Math.min(
      this.data.getLevelParam(this.level, 1) + AoeAttackSkill.DEFAULT_NEXT_EFFECT_RATE,
      AoeAttackSkill.MAX_NEXT_EFFECT_RATE
    );
  }
  ...
  constructor(_id: string, _level: number, _tower: Tower) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        3004,
        this.bounceNum,
        Position.toPercentage(1 - this.nextEffectRate),
        this.attackInfo
      );
    };
  }
...
export class BurnColdSkill extends TowerSkill {
  ...
  get burn() {
    return Math.floor(Math.sqrt(this.burnColdValue));
  }
...
export class ChangeBulletSkill extends TowerSkill {
  ...
  get bulletId() {
    return this.data.getLevelParam(this.level, 0) as string;
  }
}
...
export class ThroughoutAttackSkill extends TowerSkill {
  ...
  get nextEffectRate() {
    return Math.min(
      this.data.getLevelParam(this.level, 1) + ThroughoutAttackSkill.DEFAULT_NEXT_EFFECT_RATE,
      ThroughoutAttackSkill.MAX_NEXT_EFFECT_RATE
    );
  }
}
...
export class MonsterSkill extends BaseSkill {
  ...
  constructor(_id: string, _level: number, _monster: Monster, _isTest = false) {
    super(_id, _level, _isTest);
    this.monster = _monster;
    this.m_data.typeId = BaseSkillData.TYPE_MONSTER_SKILL;
  }

  static getKindName(_kindId: string) {
    switch (_kindId) {
...
export class MonsterEventSkill extends MonsterSkill {
  constructor(_id: string, _level: number, _monster: Monster) {
  ...
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      ...
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2303,
        Position.toGridStr(this.range(this.level + 1))
      );
      this.refreshTag();
    };
  }
...
export class CureSkill extends MonsterEventSkill {
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2300,
        Position.toGridStr(this.cureRange()),
        Position.toPercentage(this.cureRate())
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2300,
        Position.toGridStr(this.cureRange(this.level + 1)),
        Position.toPercentage(this.cureRate(this.level + 1))
      );
      this.refreshTag();
    };
  }
...
export class LinksSkill extends MonsterEventSkill {
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2728,
        Position.toGridStr(this.range()),
        Position.toPercentage(this.shieldRate()),
        this.duration()
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2728,
        Position.toGridStr(this.range(this.level + 1)),
        Position.toPercentage(this.shieldRate(this.level + 1)),
        this.duration(this.level + 1)
      );
      this.refreshTag();
    };
  ...
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2306,
        this.mirrorNum(),
        Position.toPercentage(this.hpRate()),
        this.duration()
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2306,
        this.mirrorNum(this.level + 1),
        Position.toPercentage(this.hpRate(this.level + 1)),
        this.duration(this.level + 1)
      );
      this.refreshTag();
    };
  ...
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2213,
        this.reliveNum(),
        Position.toPercentage(this.reliveHpRate())
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2213,
        this.reliveNum(this.level + 1),
        Position.toPercentage(this.reliveHpRate(this.level + 1))
      );
    };
  }
...
export class RunSkill extends MonsterEventSkill {
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2304,
        Position.toPercentage(this.speedRate() - 1),
        this.duration()
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2304,
        Position.toPercentage(this.speedRate(this.level + 1) - 1),
        this.duration(this.level + 1)
      );
      this.refreshTag();
    };
...
export class SuicideSkill extends MonsterSkill {
  ...
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      this.m_skillInfo = GlobalDataGetValue.getLanguageStr(
        2214,
        Position.toGridStr(this.cloudRange()),
        this.cloudTime()
      );
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2214,
        Position.toGridStr(this.cloudRange(this.level + 1)),
        this.cloudTime(this.level + 1)
      );
    };
  }
...
export class SummonSkill extends MonsterEventSkill {
  ...
  constructor(_id: string, _level: number, _monster: Monster) {
    ...
    this.m_updateFunction = function () {
      ...
      this.m_nextLevelSkillInfo = GlobalDataGetValue.getLanguageStr(
        2301,
        this.summonNum(this.level + 1),
        Position.toPercentage(this.hpRate(this.level + 1)),
        this.summonName(this.level + 1)
      );
      this.refreshTag(true);
    };
  }
